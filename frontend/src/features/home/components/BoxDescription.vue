    ...
    <div ref="wrapperRef" class="box-description">
      <div class="box-description-content">
        <div class="box-description-details">
          <p class="box-description-details-name">{{ portfolio.profile.fullName }}</p>
          <div class="box-description-details-location">
            <PinIcon class="box-description-details-location-icon" />
            <p class="box-description-details-location-copy">{{ [portfolio.profile.city, portfolio.profile.country].filter(Boolean).join(', ') || t("germany") }}</p>
          </div>
        </div>
        <div class="box-description-line"></div>
        <div class="box-description-copy">
          <AppearingText
            :text="portfolio.profile.description || t('about-tagline')"
            :steps="3"
            :duration="0.7"
...
.box-description {
  ...
  &-details {
    ...
    &-name {
      font-size: clamp(1rem, 6vw, var(--font-size-title-xs));
      font-weight: 700;
      white-space: nowrap;
